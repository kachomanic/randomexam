...
export const fetchAllExams = () => (dispatch) => {
  const exams = [
    ...
    {
      Question:
        "How many solutions does the following equation have? 2x² + 15x + 7 = 0",
      Img: "",
      Responses: ["1", "2", "0", "4", "3"],
      Correct: [1],
    },
    {
      Question:
        "Which of the following values for c makes a trinomial a perfect square? 4x² + 20x + c = 0",
      Img: "",
      Responses: ["c = 49", "c = 20", "c = 25", "c = 36", "c = 80"],
      Correct: [2],
    },
  ];
