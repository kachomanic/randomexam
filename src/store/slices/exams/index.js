...
export const fetchAllExams = () => (dispatch) => {
  const exams = [
    ...
    {
      Question: "Factoring Trinomials 6x^2 + 15x - 21 (x^2 means x square)",
      Img: "",
      Responses: [
        "(x + 7)(3x - 3)",
        "(2x + 7)(3x - 3)",
    ...
    },
    {
      ...
      Img: "",
      Responses: ["$250", "$500", "$625", "$420", "$575", "None of the above"],
      Correct: "2",
    },
    {
      Question:
        "26.A football team has scored 45 goals in 20 matches so far in the league. If they want to achieve an average of 3 goals per match for the remaining 10 matches, how many goals do they need to score in these matches?",
      Img: "",
