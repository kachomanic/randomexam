...
export const fetchAllExams = () => (dispatch) => {
  const exams = [
    ...
    },
    {
      ...
      Img: "",
      Responses: ["$125,250", "$125,500", "$125,000", "None of the above"],
      Correct: [2],
    },
    {
      Question:
        "A small business owner wants to apply for a loan to expand the business. The business has an average monthly revenue of $50,000 and an average monthly cost of $35,000. The bank can borrow to a business 5 times the profit plus two times their savings. If the business owner has $100,000 in savings. How much can the business owner borrow?",
      Img: "",
      Responses: ["$215,500", "$150,000", "$275,000", "$195,000", "$235,500"],
      Correct: [2],
    },
    {
      Question:
